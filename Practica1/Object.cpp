...
Object::Object(vec3 theScale, vec3 theRotation, vec3 thePosition) {
...
void Object::Rotate(vec3 theRotation) {
	this->rotation = theRotation;
}
void Object::Translate(vec3 theTranslation) {
